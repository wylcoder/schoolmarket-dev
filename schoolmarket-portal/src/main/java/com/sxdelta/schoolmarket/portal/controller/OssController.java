...
import com.sxdelta.schoolmarket.portal.service.impl.OssServiceImpl;
...
public class OssController {
    ...
    @ResponseBody
    public CommonResult<OssPolicyResult> policy(@RequestParam int filetype) {
        OssPolicyResult result = ossService.policy(filetype);
